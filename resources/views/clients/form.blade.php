            ...
            <form action="{{ route('client.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="box">
                    ...
                    <div class="columns">
                            ...
                            <div class="field">
                                ...
                                <div
                                    ...
                                    <select id="type" name="type">
                                        ...
                                        <option value="company" {{ isset($client) && $client->type == 'company' ? 'selected' : '' }}>Pessoa Jurídica</option>
                                    </select>
                                </div>
                        ...
                        <div class="column is-3">
                            <div class="field">
                                <label id="documentLabel" for="document" class="label">CPF*</label>
                                <div class="control">
                        ...
                        <div class="column is-3">
                            <div class="field">
                                <label id="aliasLabel" for="alias" class="label">Apelido</label>
                                <div class="control">
                                    <input name="alias" id="alias" class="input is-rounded" type="text"
                                           placeholder="Digite o apelido/nome fantasia"  value="{{ isset($client) ? $client->alias : '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <input name="email" id="email"
                                           ...
                                           placeholder="Digite o email"  value="{{ isset($client) ? $client->email : '' }}">
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <input name="complement" id="complement" class="input is-rounded" type="text"
                                           placeholder="Digite o complemento"  value="{{ isset($client) ? $address->complement : '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="columns">
                        <div class="column is-3">
                            <div class="field">
                                ...
                                <div class="control">
                                    <input name="uc_number" id="uc_number" value="{{ isset($client) && !is_null($consumerUnit) ? $consumerUnit->number : '' }}"
                                           class="input is-rounded  @error('zipcode') is-danger @enderror" type="text"
                            ...
                            <div class="field">
                                ...
                                <div
                                    ...
                                    <select id="uc_type" name="uc_type">
                                        ...
                                        <option @if(isset($client) && !is_null($consumerUnit)) selected @endif value="company">Empresarial</option>
                                    </select>
