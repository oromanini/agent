<div class="columns mt-2 ml-1">
    <div class="column is-9">
        <h3 class="title"><img src="/img/logo/alluz-icon.png" width="30" alt="..">Proposta  &nbsp;&nbsp;<div class="tag @if(!is_null($proposal->send_date)) is-success @else is-danger @endif">{{ !is_null($proposal->send_date) ? 'Formalizada' : 'Não formalizada' }}</div></h3>
    </div>
    ...
    <div class="column is-2 is-flex is-justify-content-start">
        <a href="{{ route('proposal.approve', [$proposal->id]) }}" class="button is-info" @if(!is_null($proposal->send_date)) disabled @endif>
