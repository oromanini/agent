<div class="columns" style="margin-top: 60px;">
    ...
    <div class="column is-3">
        ...
        <p class="proposalData">{{ $proposal->agent->name }} <a style="color: #50C55E" href="https://api.whatsapp.com/send?phone=55{{ preg_replace('/\D/', '', $proposal->agent->phone_number) }}"><ion-icon name="logo-whatsapp"></ion-icon></a></p>
    </div>
    <div class="column is-3">
