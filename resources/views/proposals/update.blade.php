        ...
        <div class="box overflow-auto">
            <form action="{{ route('proposal.updateExistentProposal', [$proposal->id]) }}" method="post">
                ...
                <div class="columns mt-2 ml-1">
                    <h3 class="title"><img src="/img/logo/alluz-icon.png" width="30" alt=".."> Editar proposta existente - #{{ $proposal->id }}</h3>
                </div>
                <div class="columns">
                ...
                <div class="columns">
                                ...
                                <div
                                    ...
                                    <select id="client" name="client">
                                        @forelse($clients as $client)
                                            <option {{ $proposal->client->id == $client->id ? 'selected' : '' }} value="{{ $client->id }}">{{$client->name}}</option>
                                        @empty
                    ...
                    <div class="column is-2">
                        <div class="field">
                            ...
                            <div class="control">
                                <input value="{{ $proposal->average_consumption }}"
                                       name="average_consumption" id="average_consumption"
                    ...
                    <div class="column is-2">
                        <div class="field">
                            ...
                            <div class="control">
                                <input value="{{ floatToMoney($proposal->kw_price)}}"
                                       name="kw_price" id="kw_price"
                    ...
                    <div class="column is-2">
                        <div class="field">
                            ...
                            <div class="select is-multiline is-fullwidth  @error('tension_pattern') is-danger @enderror">
                                <select id="tension_pattern" name="tension_pattern">
                                    @foreach($tensions as $tension)
                                        <option {{ $proposal_tension == $tension->name ? 'selected' : '' }} value="{{ $tension->value }}">{{ $tension->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                ...
                <div class="columns" style="margin-bottom: 10px">
                    @foreach($roofs as $roof)
                        <div class="column">
                            <label>
                                <input {{ $proposal->roof_structure == $roof['id']->value ? 'checked' : '' }} type="radio" name="roof_structure" value="{{$roof['id']->value}}" class="radio-image">
                ...
                <div class="columns">
                            ...
                            <div
                                ...
                                <select id="agent" name="agent">
                                    @forelse($agents as $agent)
                                        <option {{ $proposal->agent_id == $agent->id ? 'selected' : '' }} value="{{ $agent->id }}">{{$agent->name}}</option>
                                    @empty
                    ...
                    <div class="column is-2">
                        <div class="field">
                            ...
                            <div class="control">
                                <input value="{{ $proposal->kwp }}" name="kwp" id="kwp"
                    ...
                    <div class="column is-2">
                        <div class="field">
                            ...
                            <div class="control">
                                <input value="{{ $proposal->number_of_panels }}" name="panel_quantity" id="panel_quantity"
                ...
                <div class="columns">
                                    ...
                                    @forelse($panels as $panel)
                                        <option
                                            {{
                                                ...
                                                || (int) $kitInfo['panel_specs']['brand'] == $panel->brand_enum
                                                ? ' selected '
                                                : ''
                                            }}
                    ...
                    <div class="column is-2">
                        <div class="field">
                            ...
                            <div class="control">
                                <input value="{{ $kitInfo['panel_specs']['model'] }}" name="panel_model" id="panel_model"
                    ...
                    <div class="column is-2">
                        <div class="field">
                            ...
                            <div class="control">
                                <input  value="{{ $kitInfo['panel_specs']['power'] }}" name="panel_power" id="panel_power"
                    ...
                    <div class="column is-2">
                        <div class="field">
                            ...
                            <div class="control">
                                <input  value="{{ $kitInfo['panel_specs']['warranty'] }}" name="panel_warranty" id="panel_warranty"
                ...
                <div class="columns">
                    ...
                    <div class="column is-2">
                        <div class="field">
                            ...
                            <div class="control">
                                <input value="{{ $kitInfo['inverter_specs']['model'] }}" name="inverter_model" id="inverter_model"
                    ...
                    <div class="column is-2">
                        <div class="field">
                            ...
                            <div class="control">
                                <input value="{{ $kitInfo['inverter_specs']['power'] }}" name="inverter_power" id="inverter_power"
                    ...
                    <div class="column is-2">
                        <div class="field">
                            ...
                            <div class="control">
                                <input value="{{ $kitInfo['inverter_specs']['warranty'] }}" name="inverter_warranty" id="inverter_warranty"
                ...
                <div class="columns">
                    <div class="column is-12">
                        ...
                        <textarea id="components" name="components" class="textarea">{{ str_replace(",", "", implode(" ", $kitInfo['components'])) }}</textarea>
                    </div>
                </div>
                <hr>
                <div class="columns">
                    <div class="column is-3">
                        <div class="field">
                            ...
                            <div class="control has-icons-left">
                                <input value="{{ floatToMoney($valueHistory->kit_cost) }}" name="cost" id="cost"
                                       class="input is-danger @error('cost') is-danger @enderror" type="text"
                    ...
                    <div class="column is-3">
                        <div class="field">
                            <label for="final_value" class="label">Valor final à vista&nbsp;</label>
                            <div class="control has-icons-left">
                                <input value="{{ floatToMoney($valueHistory->cash_final_price) }}" name="cash_final_value" id="cash_final_value"
                                       class="input is-primary @error('cash_final_value') is-danger @enderror" type="text"
                                       placeholder="Digite o Custo" required>
                    ...
                    <div class="column is-3">
                        <div class="field">
                            <label for="final_value" class="label">Valor final financiamento&nbsp;</label>
                            <div class="control has-icons-left">
                                <input value="{{ floatToMoney($valueHistory->final_price) }}" name="final_value" id="final_value"
                                       class="input is-primary @error('final_value') is-danger @enderror" type="text"
                                       placeholder="Digite o Custo" required>
                                @error('final_value')<span class="error-message">{{ $message }}</span>@enderror
                                <span class="icon is-small is-left">
                                    <i>R$</i>
                    ...
                    <div class="column is-3">
                        <div class="field">
                            <label for="final_value" class="label">Valor final cartão&nbsp;</label>
                            <div class="control has-icons-left">
                                <input value="{{ floatToMoney($valueHistory->card_final_price) }}" name="card_final_value" id="card_final_value"
                                       class="input is-primary @error('card_final_value') is-danger @enderror" type="text"
                                       placeholder="Digite o Custo" required>
                                @error('final_value')<span class="error-message">{{ $message }}</span>@enderror
                                <span class="icon is-small is-left">
                                    <i>R$</i>
                ...
                <div class="column is-flex is-justify-content-center">
                    <button class="button is-large is-primary" type="submit">
                        <ion-icon name="cloud-upload-outline"></ion-icon>&nbsp;Atualizar
                    </button>
                </div>
            </form>
        </div>
